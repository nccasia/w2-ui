...
export const getAppMountUri = () =>
  window.__APP_CONFIG__.APP_MOUNT_URI || getAppDefaultUri();
export const getApiUrl = () => window.__APP_CONFIG__.API_URL;
...
export const MARKETPLACE_URL = window.__APP_CONFIG__.MARKETPLACE_URL;
export const MARKETPLACE_SALEOR_APPS_PAGE_PATH =
  window.__APP_CONFIG__.SALEOR_APPS_PAGE_PATH;
export const MARKETPLACE_SALEOR_APPS_JSON_PATH =
  window.__APP_CONFIG__.SALEOR_APPS_JSON_PATH;
export const MARKETPLACE_APP_TEMPLATE_GALLERY_PATH =
  window.__APP_CONFIG__.APP_TEMPLATE_GALLERY_PATH;
